  ...
  <div class="mx-auto max-w-4xl space-y-8">
    ...
    <section class="space-y-4 text-center">
      <div class="flex justify-center">
        <div
          class="flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 shadow-lg"
        >
      ...
      <div class="space-y-2">
        <h1 class="text-3xl font-bold">Contract Processing</h1>
